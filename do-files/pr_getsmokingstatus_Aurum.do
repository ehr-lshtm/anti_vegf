...
syntax, obsfile(string) therapyfile(string) smokingstatusvar(string) index(string)
...
****************************************************************************************
*GET SMOKING STATUS FROM PRESCRIPTIONS FOR NICOTINE REPLACEMENT
****************************************************************************************
...
* Ruth edit: smokstatus variable is string in codelist so updating to numeric
replace smokstatus = "0" if smokstatus=="non-smoker"
replace smokstatus = "1" if smokstatus=="current smoker"
replace smokstatus = "2" if smokstatus=="ex-smoker"
replace smokstatus = "12" if smokstatus=="current/ex-smoker"
replace smokstatus = "9" if smokstatus=="nonspecified - depends on quantity"
destring smokstatus, replace 
